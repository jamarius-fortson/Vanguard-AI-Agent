...
import importlib
try:
    from prompt_extraction_direct import extraction_prompt
except ImportError:
    from src.engine.prompt_extraction_direct import extraction_prompt

# to load the api implementation
try:
    import core.api_implementation as api
    from core.api_implementation import (Date, DateRange, ISOCode, Country, CAMEOCode, Relation, Event, NewsArticle,
    ...
    import src.core.api_implementation as api
    from src.core.api_implementation import (Date, DateRange, ISOCode, Country, CAMEOCode, Relation, Event, NewsArticle,
                        map_country_name_to_iso, map_iso_to_country_name, map_relation_description_to_cameo,
                        map_cameo_to_relation,
                        get_parent_relation, get_child_relations, get_sibling_relations, count_events, get_events,
                        get_entity_distribution, get_relation_distribution, count_news_articles, get_news_articles,
...
if __name__ == '__main__':
    ...
    parser.add_argument("--data_dir", type=str, default="./../../data/Vanguard")
    parser.add_argument("--api_dir", type=str, default="./../core/api_description_full.py")
